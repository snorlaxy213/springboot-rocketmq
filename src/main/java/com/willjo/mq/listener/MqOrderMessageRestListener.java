...
@RocketMqOrderListener(topic = MqConstant.Top.USER_ORDER_TOPIC, consumerGroup = MqConstant.ConsumeGroup.USER_GROUP)
    ...
    public MqAction consume(MessageExt message, ConsumeOrderlyContext context) {
        ...
        try {
            ...
            LOGGER.error("MsgId:{},应用MQ消费失败,Topic:{},Tag:{}，Body:{},异常信息:{}", message.getMsgId(),
                    message.getTopic(), message.getTags(), msg, e.toString());
            throw e;
        }
